...
<!-- id: where-i-step-in; cards: column -->
# Where I step in
...
Comfortable operating between strategy and deep technical work.


<!-- aside: technical-footnote
Technical background ranges from low-level systems engineering
(C/C++, Go, Lua, IoT and similar environments)

to modern product stacks and distributed platforms
(JavaScript / TypeScript ecosystems, backend services, system architecture)

as well as delivery infrastructure and engineering workflows
(GitHub Actions, Jenkins, TeamCity and comparable CI/CD environments).

Work also includes building AI-assisted tools and systems,
integrating modern AI capabilities into engineering workflows and decision-making.

If necessary, I can remove blockers directly — not only design around them.
 -->


<!-- id: work-format; cards: row -->
