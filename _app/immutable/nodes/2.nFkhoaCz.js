import{b as de,a as C,d as Ie,f as H,c as ge}from"../chunks/BN5ayv66.js";import{o as xe,h as V,n as re,z as u,q as Ce,ag as Se,t as ue,v as X,w as te,i as Y,aB as be,aJ as Me,at as pe,f as Le,c as ie,aS as N,e as se,aT as He,s as Oe,M as ze,aU as Ve,aI as ce,aV as Ne,aW as Re,aO as De,ac as he,aX as Fe,F as Be,r as ye,p as _e,b as ae,aY as Pe,aG as We,m as Ge,d as je,T as K,ae as Ye,aD as we,aZ as ke,a_ as Ze,a5 as W,D as qe,a$ as Je,aK as Ue,aE as Xe,R as Ke,b0 as Qe,b1 as $e,a7 as A,a8 as _,aR as G,a9 as B,aQ as en,B as fe,a3 as Ae,a6 as Te,a4 as Ee}from"../chunks/DpClGMvR.js";import{d as nn,s as Q,a as me}from"../chunks/CaSinb4-.js";import{p as ne,i as j}from"../chunks/DZ5pA-NQ.js";import{s as S}from"../chunks/kqMOlaZw.js";function $(e,n){return n}function tn(e,n,t){for(var l=[],d=n.length,r,o=n.length,p=0;p<d;p++){let T=n[p];_e(T,()=>{if(r){if(r.pending.delete(T),r.done.add(T),r.pending.size===0){var m=e.outrogroups;oe(e,ce(r.done)),m.delete(r),m.size===0&&(e.outrogroups=null)}}else o-=1},!1)}if(o===0){var s=l.length===0&&t!==null;if(s){var f=t,c=f.parentNode;We(c),c.append(f),e.items.clear()}oe(e,n,!s)}else r={pending:new Set(n),done:new Set},(e.outrogroups??=new Set).add(r)}function oe(e,n,t=!0){var l;if(e.pending.size>0){l=new Set;for(const o of e.pending.values())for(const p of o)l.add(e.items.get(p).e)}for(var d=0;d<n.length;d++){var r=n[d];if(l?.has(r)){r.f|=N;const o=document.createDocumentFragment();Ge(r,o)}else je(n[d],t)}}var ve;function ee(e,n,t,l,d,r=null){var o=e,p=new Map,s=(n&ke)!==0;if(s){var f=e;o=V?X(K(f)):f.appendChild(ie())}V&&re();var c=null,T=ze(()=>{var a=t();return Ve(a)?a:a==null?[]:ce(a)}),m,M=new Map,L=!0;function R(a){(z.effect.f&Be)===0&&(z.pending.delete(a),z.fallback=c,an(z,m,o,n,l),c!==null&&(m.length===0?(c.f&N)===0?ye(c):(c.f^=N,J(c,null,o)):_e(c,()=>{c=null})))}function i(a){z.pending.delete(a)}var y=xe(()=>{m=u(T);var a=m.length;let h=!1;if(V){var I=Ce(o)===Se;I!==(a===0)&&(o=ue(),X(o),te(!1),h=!0)}for(var E=new Set,b=Le,x=Oe(),k=0;k<a;k+=1){V&&Y.nodeType===be&&Y.data===Me&&(o=Y,h=!0,te(!1));var v=m[k],w=l(v,k),g=L?null:p.get(w);g?(g.v&&pe(g.v,v),g.i&&pe(g.i,k),x&&b.unskip_effect(g.e)):(g=rn(p,L?o:ve??=ie(),v,w,k,d,n,t),L||(g.e.f|=N),p.set(w,g)),E.add(w)}if(a===0&&r&&!c&&(L?c=se(()=>r(o)):(c=se(()=>r(ve??=ie())),c.f|=N)),a>E.size&&He(),V&&a>0&&X(ue()),!L)if(M.set(b,E),x){for(const[O,D]of p)E.has(O)||b.skip_effect(D.e);b.oncommit(R),b.ondiscard(i)}else R(b);h&&te(!0),u(T)}),z={effect:y,items:p,pending:M,outrogroups:null,fallback:c};L=!1,V&&(o=Y)}function q(e){for(;e!==null&&(e.f&Pe)===0;)e=e.next;return e}function an(e,n,t,l,d){var r=(l&Ze)!==0,o=n.length,p=e.items,s=q(e.effect.first),f,c=null,T,m=[],M=[],L,R,i,y;if(r)for(y=0;y<o;y+=1)L=n[y],R=d(L,y),i=p.get(R).e,(i.f&N)===0&&(i.nodes?.a?.measure(),(T??=new Set).add(i));for(y=0;y<o;y+=1){if(L=n[y],R=d(L,y),i=p.get(R).e,e.outrogroups!==null)for(const v of e.outrogroups)v.pending.delete(i),v.done.delete(i);if((i.f&N)!==0)if(i.f^=N,i===s)J(i,null,t);else{var z=c?c.next:s;i===e.effect.last&&(e.effect.last=i.prev),i.prev&&(i.prev.next=i.next),i.next&&(i.next.prev=i.prev),F(e,c,i),F(e,i,z),J(i,z,t),c=i,m=[],M=[],s=q(c.next);continue}if((i.f&ae)!==0&&(ye(i),r&&(i.nodes?.a?.unfix(),(T??=new Set).delete(i))),i!==s){if(f!==void 0&&f.has(i)){if(m.length<M.length){var a=M[0],h;c=a.prev;var I=m[0],E=m[m.length-1];for(h=0;h<m.length;h+=1)J(m[h],a,t);for(h=0;h<M.length;h+=1)f.delete(M[h]);F(e,I.prev,E.next),F(e,c,I),F(e,E,a),s=a,c=E,y-=1,m=[],M=[]}else f.delete(i),J(i,s,t),F(e,i.prev,i.next),F(e,i,c===null?e.effect.first:c.next),F(e,c,i),c=i;continue}for(m=[],M=[];s!==null&&s!==i;)(f??=new Set).add(s),M.push(s),s=q(s.next);if(s===null)continue}(i.f&N)===0&&m.push(i),c=i,s=q(i.next)}if(e.outrogroups!==null){for(const v of e.outrogroups)v.pending.size===0&&(oe(e,ce(v.done)),e.outrogroups?.delete(v));e.outrogroups.size===0&&(e.outrogroups=null)}if(s!==null||f!==void 0){var b=[];if(f!==void 0)for(i of f)(i.f&ae)===0&&b.push(i);for(;s!==null;)(s.f&ae)===0&&s!==e.fallback&&b.push(s),s=q(s.next);var x=b.length;if(x>0){var k=(l&ke)!==0&&o===0?t:null;if(r){for(y=0;y<x;y+=1)b[y].nodes?.a?.measure();for(y=0;y<x;y+=1)b[y].nodes?.a?.fix()}tn(e,b,k)}}r&&Ye(()=>{if(T!==void 0)for(i of T)i.nodes?.a?.apply()})}function rn(e,n,t,l,d,r,o,p){var s=(o&Ne)!==0?(o&Re)===0?De(t,!1,!1):he(t):null,f=(o&Fe)!==0?he(d):null;return{v:s,i:f,e:se(()=>(r(n,s??t,f??d,p),()=>{e.delete(l)}))}}function J(e,n,t){if(e.nodes)for(var l=e.nodes.start,d=e.nodes.end,r=n&&(n.f&N)===0?n.nodes.start:t;l!==null;){var o=we(l);if(r.before(l),l===d)return;l=o}}function F(e,n,t){n===null?e.effect.first=t:n.next=t,t===null?e.effect.last=n:t.prev=n}function P(e,n,t=!1,l=!1,d=!1){var r=e,o="";W(()=>{var p=qe;if(o===(o=n()??"")){V&&re();return}if(p.nodes!==null&&(Je(p.nodes.start,p.nodes.end),p.nodes=null),o!==""){if(V){Y.data;for(var s=re(),f=s;s!==null&&(s.nodeType!==be||s.data!=="");)f=s,s=we(s);if(s===null)throw Ue(),Xe;de(Y,f),r=X(s);return}var c=t?Qe:l?$e:void 0,T=Ke(t?"svg":l?"math":"template",c);T.innerHTML=o;var m=t||l?T:T.content;if(de(K(m),m.lastChild),t||l)for(;K(m);)r.before(K(m));else r.before(m)}})}function sn(e,n,t){var l=e==null?"":""+e;return l===""?null:l}function le(e,n,t,l,d,r){var o=e.__className;if(V||o!==t||o===void 0){var p=sn(t);(!V||p!==e.getAttribute("class"))&&(p==null?e.removeAttribute("class"):n?e.className=p:e.setAttribute("class",p)),e.__className=t}return r}const on={hero:{intro:`<h1>Firestarter</h1>
...
`,contactLinks:[{label:"Email",href:"mailto:a.burdun@gmail.com",icon:null},{label:"LinkedIn",href:"https://linkedin.com/in/dukobpa3",icon:null},{label:"Telegram",href:"https://t.me/buhomlab",icon:null}]},identity:`<p>Strategist — identify the real constraint</p>
