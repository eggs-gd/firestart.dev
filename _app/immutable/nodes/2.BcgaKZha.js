import{b as de,a as S,d as Ie,f as H,c as ge}from"../chunks/BN5ayv66.js";import{o as Ce,h as V,n as re,z as u,q as Se,ag as xe,t as ue,v as X,w as te,i as Y,aB as _e,aJ as Me,at as fe,f as Le,c as ie,aS as R,e as se,aT as He,s as Oe,M as ze,aU as Ve,aI as ce,aV as Re,aW as Ne,aO as De,ac as pe,aX as Fe,F as Be,r as be,p as ye,b as ae,aY as Pe,aG as We,m as Ge,d as je,T as K,ae as Ye,aD as we,aZ as ke,a_ as Ze,a5 as W,D as qe,a$ as Je,aK as Ue,aE as Xe,R as Ke,b0 as Qe,b1 as $e,a7 as A,a8 as y,aR as G,a9 as B,aQ as en,B as he,a3 as Ae,a6 as Te,a4 as Ee}from"../chunks/DpClGMvR.js";import{d as nn,s as Q,a as ve}from"../chunks/CaSinb4-.js";import{p as ne,i as j}from"../chunks/DZ5pA-NQ.js";import{s as x}from"../chunks/kqMOlaZw.js";function $(e,n){return n}function tn(e,n,t){for(var l=[],d=n.length,r,o=n.length,f=0;f<d;f++){let T=n[f];ye(T,()=>{if(r){if(r.pending.delete(T),r.done.add(T),r.pending.size===0){var v=e.outrogroups;oe(e,ce(r.done)),v.delete(r),v.size===0&&(e.outrogroups=null)}}else o-=1},!1)}if(o===0){var s=l.length===0&&t!==null;if(s){var h=t,c=h.parentNode;We(c),c.append(h),e.items.clear()}oe(e,n,!s)}else r={pending:new Set(n),done:new Set},(e.outrogroups??=new Set).add(r)}function oe(e,n,t=!0){var l;if(e.pending.size>0){l=new Set;for(const o of e.pending.values())for(const f of o)l.add(e.items.get(f).e)}for(var d=0;d<n.length;d++){var r=n[d];if(l?.has(r)){r.f|=R;const o=document.createDocumentFragment();Ge(r,o)}else je(n[d],t)}}var me;function ee(e,n,t,l,d,r=null){var o=e,f=new Map,s=(n&ke)!==0;if(s){var h=e;o=V?X(K(h)):h.appendChild(ie())}V&&re();var c=null,T=ze(()=>{var a=t();return Ve(a)?a:a==null?[]:ce(a)}),v,M=new Map,L=!0;function N(a){(z.effect.f&Be)===0&&(z.pending.delete(a),z.fallback=c,an(z,v,o,n,l),c!==null&&(v.length===0?(c.f&R)===0?be(c):(c.f^=R,J(c,null,o)):ye(c,()=>{c=null})))}function i(a){z.pending.delete(a)}var b=Ce(()=>{v=u(T);var a=v.length;let p=!1;if(V){var I=Se(o)===xe;I!==(a===0)&&(o=ue(),X(o),te(!1),p=!0)}for(var E=new Set,_=Le,C=Oe(),k=0;k<a;k+=1){V&&Y.nodeType===_e&&Y.data===Me&&(o=Y,p=!0,te(!1));var m=v[k],w=l(m,k),g=L?null:f.get(w);g?(g.v&&fe(g.v,m),g.i&&fe(g.i,k),C&&_.unskip_effect(g.e)):(g=rn(f,L?o:me??=ie(),m,w,k,d,n,t),L||(g.e.f|=R),f.set(w,g)),E.add(w)}if(a===0&&r&&!c&&(L?c=se(()=>r(o)):(c=se(()=>r(me??=ie())),c.f|=R)),a>E.size&&He(),V&&a>0&&X(ue()),!L)if(M.set(_,E),C){for(const[O,D]of f)E.has(O)||_.skip_effect(D.e);_.oncommit(N),_.ondiscard(i)}else N(_);p&&te(!0),u(T)}),z={effect:b,items:f,pending:M,outrogroups:null,fallback:c};L=!1,V&&(o=Y)}function q(e){for(;e!==null&&(e.f&Pe)===0;)e=e.next;return e}function an(e,n,t,l,d){var r=(l&Ze)!==0,o=n.length,f=e.items,s=q(e.effect.first),h,c=null,T,v=[],M=[],L,N,i,b;if(r)for(b=0;b<o;b+=1)L=n[b],N=d(L,b),i=f.get(N).e,(i.f&R)===0&&(i.nodes?.a?.measure(),(T??=new Set).add(i));for(b=0;b<o;b+=1){if(L=n[b],N=d(L,b),i=f.get(N).e,e.outrogroups!==null)for(const m of e.outrogroups)m.pending.delete(i),m.done.delete(i);if((i.f&R)!==0)if(i.f^=R,i===s)J(i,null,t);else{var z=c?c.next:s;i===e.effect.last&&(e.effect.last=i.prev),i.prev&&(i.prev.next=i.next),i.next&&(i.next.prev=i.prev),F(e,c,i),F(e,i,z),J(i,z,t),c=i,v=[],M=[],s=q(c.next);continue}if((i.f&ae)!==0&&(be(i),r&&(i.nodes?.a?.unfix(),(T??=new Set).delete(i))),i!==s){if(h!==void 0&&h.has(i)){if(v.length<M.length){var a=M[0],p;c=a.prev;var I=v[0],E=v[v.length-1];for(p=0;p<v.length;p+=1)J(v[p],a,t);for(p=0;p<M.length;p+=1)h.delete(M[p]);F(e,I.prev,E.next),F(e,c,I),F(e,E,a),s=a,c=E,b-=1,v=[],M=[]}else h.delete(i),J(i,s,t),F(e,i.prev,i.next),F(e,i,c===null?e.effect.first:c.next),F(e,c,i),c=i;continue}for(v=[],M=[];s!==null&&s!==i;)(h??=new Set).add(s),M.push(s),s=q(s.next);if(s===null)continue}(i.f&R)===0&&v.push(i),c=i,s=q(i.next)}if(e.outrogroups!==null){for(const m of e.outrogroups)m.pending.size===0&&(oe(e,ce(m.done)),e.outrogroups?.delete(m));e.outrogroups.size===0&&(e.outrogroups=null)}if(s!==null||h!==void 0){var _=[];if(h!==void 0)for(i of h)(i.f&ae)===0&&_.push(i);for(;s!==null;)(s.f&ae)===0&&s!==e.fallback&&_.push(s),s=q(s.next);var C=_.length;if(C>0){var k=(l&ke)!==0&&o===0?t:null;if(r){for(b=0;b<C;b+=1)_[b].nodes?.a?.measure();for(b=0;b<C;b+=1)_[b].nodes?.a?.fix()}tn(e,_,k)}}r&&Ye(()=>{if(T!==void 0)for(i of T)i.nodes?.a?.apply()})}function rn(e,n,t,l,d,r,o,f){var s=(o&Re)!==0?(o&Ne)===0?De(t,!1,!1):pe(t):null,h=(o&Fe)!==0?pe(d):null;return{v:s,i:h,e:se(()=>(r(n,s??t,h??d,f),()=>{e.delete(l)}))}}function J(e,n,t){if(e.nodes)for(var l=e.nodes.start,d=e.nodes.end,r=n&&(n.f&R)===0?n.nodes.start:t;l!==null;){var o=we(l);if(r.before(l),l===d)return;l=o}}function F(e,n,t){n===null?e.effect.first=t:n.next=t,t===null?e.effect.last=n:t.prev=n}function P(e,n,t=!1,l=!1,d=!1){var r=e,o="";W(()=>{var f=qe;if(o===(o=n()??"")){V&&re();return}if(f.nodes!==null&&(Je(f.nodes.start,f.nodes.end),f.nodes=null),o!==""){if(V){Y.data;for(var s=re(),h=s;s!==null&&(s.nodeType!==_e||s.data!=="");)h=s,s=we(s);if(s===null)throw Ue(),Xe;de(Y,h),r=X(s);return}var c=t?Qe:l?$e:void 0,T=Ke(t?"svg":l?"math":"template",c);T.innerHTML=o;var v=t||l?T:T.content;if(de(K(v),v.lastChild),t||l)for(;K(v);)r.before(K(v));else r.before(v)}})}function sn(e,n,t){var l=e==null?"":""+e;return l===""?null:l}function le(e,n,t,l,d,r){var o=e.__className;if(V||o!==t||o===void 0){var f=sn(t);(!V||f!==e.getAttribute("class"))&&(f==null?e.removeAttribute("class"):n?e.className=f:e.setAttribute("class",f)),e.__className=t}return r}const on={hero:{intro:`<h1>Firestarter</h1>
<p>I step into complex projects when execution stops moving.</p>
<p>Identify the real constraint.<br>Restore momentum.</p>
`,contactLinks:[{label:"Email",href:"mailto:a.burdun@gmail.com",icon:null},{label:"LinkedIn",href:"https://linkedin.com/in/dukobpa3",icon:null},{label:"Telegram",href:"https://t.me/buhomlab",icon:null}]},identity:`<p>Strategist — finding the real constraint</p>
