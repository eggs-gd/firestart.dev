import{b as de,a as x,d as Ee,f as V,c as ge}from"../chunks/BN5ayv66.js";import{o as Ie,h as O,n as re,z as u,q as xe,ag as Ce,t as ue,v as X,w as te,i as j,aB as be,aJ as Me,at as pe,f as Se,c as ie,aS as N,e as se,aT as Ve,s as Le,M as ze,aU as Oe,aI as ce,aV as Ne,aW as Re,aO as De,ac as he,aX as Fe,F as Be,r as ye,p as _e,b as ae,aY as Pe,aG as We,m as Ge,d as Ze,T as K,ae as je,aD as we,aZ as ke,a_ as Ye,a5 as W,D as qe,a$ as Je,aK as Ue,aE as Xe,R as Ke,b0 as Qe,b1 as $e,a7 as A,a8 as _,aR as G,a9 as B,aQ as en,B as fe,a3 as Ae,a6 as Te,a4 as He}from"../chunks/DpClGMvR.js";import{d as nn,s as Q,a as me}from"../chunks/CaSinb4-.js";import{p as ne,i as Z}from"../chunks/DZ5pA-NQ.js";import{s as C}from"../chunks/kqMOlaZw.js";function $(e,n){return n}function tn(e,n,t){for(var l=[],d=n.length,r,o=n.length,p=0;p<d;p++){let T=n[p];_e(T,()=>{if(r){if(r.pending.delete(T),r.done.add(T),r.pending.size===0){var m=e.outrogroups;oe(e,ce(r.done)),m.delete(r),m.size===0&&(e.outrogroups=null)}}else o-=1},!1)}if(o===0){var s=l.length===0&&t!==null;if(s){var f=t,c=f.parentNode;We(c),c.append(f),e.items.clear()}oe(e,n,!s)}else r={pending:new Set(n),done:new Set},(e.outrogroups??=new Set).add(r)}function oe(e,n,t=!0){var l;if(e.pending.size>0){l=new Set;for(const o of e.pending.values())for(const p of o)l.add(e.items.get(p).e)}for(var d=0;d<n.length;d++){var r=n[d];if(l?.has(r)){r.f|=N;const o=document.createDocumentFragment();Ge(r,o)}else Ze(n[d],t)}}var ve;function ee(e,n,t,l,d,r=null){var o=e,p=new Map,s=(n&ke)!==0;if(s){var f=e;o=O?X(K(f)):f.appendChild(ie())}O&&re();var c=null,T=ze(()=>{var a=t();return Oe(a)?a:a==null?[]:ce(a)}),m,M=new Map,S=!0;function R(a){(z.effect.f&Be)===0&&(z.pending.delete(a),z.fallback=c,an(z,m,o,n,l),c!==null&&(m.length===0?(c.f&N)===0?ye(c):(c.f^=N,J(c,null,o)):_e(c,()=>{c=null})))}function i(a){z.pending.delete(a)}var y=Ie(()=>{m=u(T);var a=m.length;let h=!1;if(O){var E=xe(o)===Ce;E!==(a===0)&&(o=ue(),X(o),te(!1),h=!0)}for(var H=new Set,b=Se,I=Le(),k=0;k<a;k+=1){O&&j.nodeType===be&&j.data===Me&&(o=j,h=!0,te(!1));var v=m[k],w=l(v,k),g=S?null:p.get(w);g?(g.v&&pe(g.v,v),g.i&&pe(g.i,k),I&&b.unskip_effect(g.e)):(g=rn(p,S?o:ve??=ie(),v,w,k,d,n,t),S||(g.e.f|=N),p.set(w,g)),H.add(w)}if(a===0&&r&&!c&&(S?c=se(()=>r(o)):(c=se(()=>r(ve??=ie())),c.f|=N)),a>H.size&&Ve(),O&&a>0&&X(ue()),!S)if(M.set(b,H),I){for(const[L,D]of p)H.has(L)||b.skip_effect(D.e);b.oncommit(R),b.ondiscard(i)}else R(b);h&&te(!0),u(T)}),z={effect:y,items:p,pending:M,outrogroups:null,fallback:c};S=!1,O&&(o=j)}function q(e){for(;e!==null&&(e.f&Pe)===0;)e=e.next;return e}function an(e,n,t,l,d){var r=(l&Ye)!==0,o=n.length,p=e.items,s=q(e.effect.first),f,c=null,T,m=[],M=[],S,R,i,y;if(r)for(y=0;y<o;y+=1)S=n[y],R=d(S,y),i=p.get(R).e,(i.f&N)===0&&(i.nodes?.a?.measure(),(T??=new Set).add(i));for(y=0;y<o;y+=1){if(S=n[y],R=d(S,y),i=p.get(R).e,e.outrogroups!==null)for(const v of e.outrogroups)v.pending.delete(i),v.done.delete(i);if((i.f&N)!==0)if(i.f^=N,i===s)J(i,null,t);else{var z=c?c.next:s;i===e.effect.last&&(e.effect.last=i.prev),i.prev&&(i.prev.next=i.next),i.next&&(i.next.prev=i.prev),F(e,c,i),F(e,i,z),J(i,z,t),c=i,m=[],M=[],s=q(c.next);continue}if((i.f&ae)!==0&&(ye(i),r&&(i.nodes?.a?.unfix(),(T??=new Set).delete(i))),i!==s){if(f!==void 0&&f.has(i)){if(m.length<M.length){var a=M[0],h;c=a.prev;var E=m[0],H=m[m.length-1];for(h=0;h<m.length;h+=1)J(m[h],a,t);for(h=0;h<M.length;h+=1)f.delete(M[h]);F(e,E.prev,H.next),F(e,c,E),F(e,H,a),s=a,c=H,y-=1,m=[],M=[]}else f.delete(i),J(i,s,t),F(e,i.prev,i.next),F(e,i,c===null?e.effect.first:c.next),F(e,c,i),c=i;continue}for(m=[],M=[];s!==null&&s!==i;)(f??=new Set).add(s),M.push(s),s=q(s.next);if(s===null)continue}(i.f&N)===0&&m.push(i),c=i,s=q(i.next)}if(e.outrogroups!==null){for(const v of e.outrogroups)v.pending.size===0&&(oe(e,ce(v.done)),e.outrogroups?.delete(v));e.outrogroups.size===0&&(e.outrogroups=null)}if(s!==null||f!==void 0){var b=[];if(f!==void 0)for(i of f)(i.f&ae)===0&&b.push(i);for(;s!==null;)(s.f&ae)===0&&s!==e.fallback&&b.push(s),s=q(s.next);var I=b.length;if(I>0){var k=(l&ke)!==0&&o===0?t:null;if(r){for(y=0;y<I;y+=1)b[y].nodes?.a?.measure();for(y=0;y<I;y+=1)b[y].nodes?.a?.fix()}tn(e,b,k)}}r&&je(()=>{if(T!==void 0)for(i of T)i.nodes?.a?.apply()})}function rn(e,n,t,l,d,r,o,p){var s=(o&Ne)!==0?(o&Re)===0?De(t,!1,!1):he(t):null,f=(o&Fe)!==0?he(d):null;return{v:s,i:f,e:se(()=>(r(n,s??t,f??d,p),()=>{e.delete(l)}))}}function J(e,n,t){if(e.nodes)for(var l=e.nodes.start,d=e.nodes.end,r=n&&(n.f&N)===0?n.nodes.start:t;l!==null;){var o=we(l);if(r.before(l),l===d)return;l=o}}function F(e,n,t){n===null?e.effect.first=t:n.next=t,t===null?e.effect.last=n:t.prev=n}function P(e,n,t=!1,l=!1,d=!1){var r=e,o="";W(()=>{var p=qe;if(o===(o=n()??"")){O&&re();return}if(p.nodes!==null&&(Je(p.nodes.start,p.nodes.end),p.nodes=null),o!==""){if(O){j.data;for(var s=re(),f=s;s!==null&&(s.nodeType!==be||s.data!=="");)f=s,s=we(s);if(s===null)throw Ue(),Xe;de(j,f),r=X(s);return}var c=t?Qe:l?$e:void 0,T=Ke(t?"svg":l?"math":"template",c);T.innerHTML=o;var m=t||l?T:T.content;if(de(K(m),m.lastChild),t||l)for(;K(m);)r.before(K(m));else r.before(m)}})}function sn(e,n,t){var l=e==null?"":""+e;return l===""?null:l}function le(e,n,t,l,d,r){var o=e.__className;if(O||o!==t||o===void 0){var p=sn(t);(!O||p!==e.getAttribute("class"))&&(p==null?e.removeAttribute("class"):n?e.className=p:e.setAttribute("class",p)),e.__className=t}return r}const on={hero:{intro:`<h1>Firestarter</h1>
...
`,contactLinks:[{label:"Email",href:"mailto:a.burdun@gmail.com",icon:null},{label:"LinkedIn",href:"https://linkedin.com/in/dukobpa3",icon:null},{label:"Telegram",href:"https://t.me/Dukobpa3",icon:null},{label:"Homelab",href:"https://eggs.gd/",icon:null}]},identity:`<p>Strategist — identify the real constraint</p>
...
<p>The role emerges from what the system actually needs — not from a predefined title.</p>
<p>I may operate across architecture, leadership and execution within the same engagement.</p>
...
<span class="about-photo__accent">Engineer — making everything from everything<br>minimizing entropy</span></p>
...
`,contactLinks:[{label:"Email",href:"mailto:a.burdun@gmail.com",icon:null},{label:"LinkedIn",href:"https://linkedin.com/in/dukobpa3",icon:null},{label:"Telegram",href:"https://t.me/Dukobpa3",icon:null},{label:"Homelab",href:"https://eggs.gd/",icon:null}]}},ln=["hero","identity","what-i-do","where-i-step-in","results","manifesto","perspective","failure-modes","how-i-work","deliverables","reality","what-i-dont-do","background","work-format","about-photo","principles","current-focus","closing","contact"],cn={"where-i-step-in":{cards:"column"},"work-format":{cards:"row"}},dn={sections:on,sectionOrder:ln,sectionOptions:cn};function un(){const{sections:e,sectionOrder:n,sectionOptions:t={}}=dn;return{sections:e,sectionOrder:n,sectionOptions:t}}const Pn=Object.freeze(Object.defineProperty({__proto__:null,load:un},Symbol.toStringTag,{value:"Module"}));var pn=Ee('<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor"></path></svg>');function hn(e,n){let t=ne(n,"size",3,1.25),l=ne(n,"class",3,"");const d=G(()=>`${t()*16}px`);var r=pn(),o=A(r);_(r),W(()=>{le(r,0,`icon ${l()??""}`),C(r,"width",u(d)),C(r,"height",u(d)),C(o,"d",n.path)}),x(e,r)}var fn=V('<div class="aside-line"><div class="aside-line__trigger" role="button" tabindex="0"><span class="aside-line__text"><!></span> <span class="aside-line__chevron" aria-hidden="true"> </span></div> <div class="aside-line__body prose" role="region"><!></div></div>');function mn(e,n){let t=en(!1);var l=fn(),d=A(l),r=A(d),o=A(r);P(o,()=>n.trigger),_(r);var p=B(r,2),s=A(p,!0);_(p),_(d);var f=B(d,2),c=A(f);P(c,()=>n.body),_(f),_(l),W(()=>{C(l,"data-aside-id",n.id),C(d,"aria-expanded",u(t)),C(d,"aria-controls",`${n.id??""}-aside-body`),C(d,"id",`${n.id??""}-aside-trigger`),Q(s,u(t)?"▼":"▶"),C(f,"id",`${n.id??""}-aside-body`),C(f,"aria-labelledby",`${n.id??""}-aside-trigger`),C(f,"hidden",!u(t))}),me("click",d,()=>fe(t,!u(t))),me("keydown",d,T=>T.key==="Enter"&&fe(t,!u(t))),x(e,l)}nn(["click","keydown"]);var vn="M20,8L12,13L4,8V6L12,11L20,6M20,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6C22,4.89 21.1,4 20,4Z",gn="M7.8,2H16.2C19.4,2 22,4.6 22,7.8V16.2A5.8,5.8 0 0,1 16.2,22H7.8C4.6,22 2,19.4 2,16.2V7.8A5.8,5.8 0 0,1 7.8,2M7.6,4A3.6,3.6 0 0,0 4,7.6V16.4C4,18.39 5.61,20 7.6,20H16.4A3.6,3.6 0 0,0 20,16.4V7.6C20,5.61 18.39,4 16.4,4H7.6M17.25,5.5A1.25,1.25 0 0,1 18.5,6.75A1.25,1.25 0 0,1 17.25,8A1.25,1.25 0 0,1 16,6.75A1.25,1.25 0 0,1 17.25,5.5M12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9Z",bn="M19 3A2 2 0 0 1 21 5V19A2 2 0 0 1 19 21H5A2 2 0 0 1 3 19V5A2 2 0 0 1 5 3H19M18.5 18.5V13.2A3.26 3.26 0 0 0 15.24 9.94C14.39 9.94 13.4 10.46 12.92 11.24V10.13H10.13V18.5H12.92V13.57C12.92 12.8 13.54 12.17 14.31 12.17A1.4 1.4 0 0 1 15.71 13.57V18.5H18.5M6.88 8.56A1.68 1.68 0 0 0 8.56 6.88C8.56 5.95 7.81 5.19 6.88 5.19A1.69 1.69 0 0 0 5.19 6.88C5.19 7.81 5.95 8.56 6.88 8.56M8.27 18.5V10.13H5.5V18.5H8.27Z",yn="M2,21L23,12L2,3V10L17,12L2,14V21Z",_n="M13,19H14A1,1 0 0,1 15,20H22V22H15A1,1 0 0,1 14,23H10A1,1 0 0,1 9,22H2V20H9A1,1 0 0,1 10,19H11V17H4A1,1 0 0,1 3,16V12A1,1 0 0,1 4,11H20A1,1 0 0,1 21,12V16A1,1 0 0,1 20,17H13V19M4,3H20A1,1 0 0,1 21,4V8A1,1 0 0,1 20,9H4A1,1 0 0,1 3,8V4A1,1 0 0,1 4,3M9,7H10V5H9V7M9,15H10V13H9V15M5,5V7H7V5H5M5,13V15H7V13H5Z";const wn={email:vn,linkedin:bn,instagram:gn,telegram:yn,homelab:_n};function kn(e){if(!e)return;const n=e.toLowerCase().trim();return wn[n]}var An=V('<h2 class="section__title"> </h2>'),Tn=V('<div class="block__intro prose"><!></div>'),Hn=V('<a class="contact-links__item" rel="noopener noreferrer" target="_blank"><!> <span class="contact-links__label"> </span></a>'),En=V('<div class="block block--contact"><!> <nav class="contact-links" aria-label="Contact"></nav></div>'),In=V('<div class="prose"><!></div>'),xn=V('<div class="section__body"></div>'),Cn=V('<div class="block__intro prose"><!></div>'),Mn=V('<article class="card"><h3 class="card__title"> </h3> <div class="card__body prose"><!></div></article>'),Sn=V('<footer class="block__footer prose"><!></footer>'),Vn=V('<div class="block"><!> <div></div> <!></div>'),Ln=V('<div class="section__body prose"><!></div>'),zn=V("<section><!> <!></section>");function On(e,n){Ae(n,!0);let t=ne(n,"title",3,""),l=ne(n,"cardsLayout",3,"row");const d=a=>typeof a=="object"&&a!==null&&Array.isArray(a.cards),r=a=>typeof a=="object"&&a!==null&&Array.isArray(a.contactLinks),o=a=>typeof a=="object"&&a!==null&&Array.isArray(a.blocks);function p(a){return a.type==="aside"}var s=zn(),f=A(s);{var c=a=>{var h=An(),E=A(h,!0);_(h),W(()=>{C(h,"id",`${n.id??""}-heading`),Q(E,t())}),x(a,h)};Z(f,a=>{t()&&a(c)})}var T=B(f,2);{var m=a=>{var h=En(),E=A(h);{var H=I=>{var k=Tn(),v=A(k);P(v,()=>n.html.intro),_(k),x(I,k)};Z(E,I=>{n.html.intro&&I(H)})}var b=B(E,2);ee(b,21,()=>n.html.contactLinks,$,(I,k)=>{const v=G(()=>kn(u(k).icon??u(k).label));var w=Hn(),g=A(w);{var L=Y=>{hn(Y,{get path(){return u(v)},size:1.25,class:"contact-links__icon"})};Z(g,Y=>{u(v)&&Y(L)})}var D=B(g,2),U=A(D,!0);_(D),_(w),W(()=>{C(w,"href",u(k).href),Q(U,u(k).label)}),x(I,w)}),_(b),_(h),x(a,h)},M=G(()=>r(n.html)),S=a=>{var h=xn();ee(h,21,()=>n.html.blocks,$,(E,H)=>{var b=ge(),I=He(b);{var k=g=>{var L=In(),D=A(L);P(D,()=>u(H).content),_(L),x(g,L)},v=g=>{mn(g,{get id(){return u(H).id},get trigger(){return u(H).trigger},get body(){return u(H).body}})},w=G(()=>p(u(H)));Z(I,g=>{u(H).type==="html"?g(k):u(w)&&g(v,1)})}x(E,b)}),_(h),x(a,h)},R=G(()=>o(n.html)),i=a=>{var h=Vn(),E=A(h);{var H=v=>{var w=Cn(),g=A(w);P(g,()=>n.html.intro),_(w),x(v,w)};Z(E,v=>{n.html.intro&&v(H)})}var b=B(E,2);ee(b,21,()=>n.html.cards,$,(v,w)=>{var g=Mn(),L=A(g),D=A(L,!0);_(L);var U=B(L,2),Y=A(U);P(Y,()=>u(w).html),_(U),_(g),W(()=>Q(D,u(w).title)),x(v,g)}),_(b);var I=B(b,2);{var k=v=>{var w=Sn(),g=A(w);P(g,()=>n.html.footer),_(w),x(v,w)};Z(I,v=>{n.html.footer&&v(k)})}_(h),W(()=>le(b,1,`block__cards block__cards--${l()??""}`)),x(a,h)},y=G(()=>d(n.html)),z=a=>{var h=Ln(),E=A(h);P(E,()=>n.html),_(h),x(a,h)};Z(T,a=>{u(M)?a(m):u(R)?a(S,1):u(y)?a(i,2):a(z,-1)})}_(s),W(()=>{C(s,"id",n.id),le(s,1,`section section--${n.id??""}`),C(s,"aria-labelledby",t()?`${n.id}-heading`:void 0)}),x(e,s),Te()}function Wn(e,n){Ae(n,!0);var t=ge(),l=He(t);ee(l,17,()=>n.data.sectionOrder,$,(d,r)=>{const o=G(()=>n.data.sectionOptions[u(r)]);{let p=G(()=>u(o)?.cards==="row"||u(o)?.cards==="column"?u(o).cards:void 0);On(d,{get id(){return u(r)},get html(){return n.data.sections[u(r)]},get cardsLayout(){return u(p)}})}}),x(e,t),Te()}export{Wn as component,Pn as universal};
